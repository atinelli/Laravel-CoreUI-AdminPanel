...
<div class="card">
    <div class="card-header">
        {{ trans('global.edit') }} {{ trans('global.paciente.title_singular') }}
    </div>
    ...
    <div class="card-body">
        <form action="{{ route("admin.pacientes.update", [$paciente->id]) }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="form-group col-sm-6 {{ $errors->has('dt_nascimento') ? 'has-error' : '' }}">
                ...
                <input type="date" id="dt_nascimento" name="dt_nascimento" class="form-control" value="{{ old('dt_nascimento', isset($paciente) ? $paciente->dt_nascimento->toDateString() : '') }}">
            ...
            <div class="form-group col-sm-6 {{ $errors->has('dt_internacao') ? 'has-error' : '' }}">
                ...
                <input type="date" id="dt_internacao" name="dt_internacao" class="form-control" value="{{ old('dt_internacao', isset($paciente) ? $paciente->dt_internacao->toDateString() : '') }}">
